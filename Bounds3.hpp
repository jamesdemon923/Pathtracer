                                ...
                                const std::array<int, 3>& dirIsNeg) const
{
    ...
    //dirIsNeg the direction of the ray, if it is the positive direction(value = 0), pmin-Orig is the shortest path
    //If it is the negative direction (value = 1), pmax-Orig is the shortest path
